...
#import "WarCraft3Sound.h"


@implementation WarCraft3Sound
...
- (NSString*)pluginName {
	return @"WarCraft3 Sound";
}

- (NSString*)pluginDescription {
	return NSLocalizedStringFromTableInBundle(@"LQPluginDescription", @"WarCraft3Sound", [NSBundle bundleForClass:[self class]], nil);
}
