...
@implementation GetOnlineMemberJob
...
- (void)_getNext {
	if(_next >= [_clusters count]) {
		...
		_waitingSequence = [[m_delegate client] getOnlineMember:[c internalId]];
	}
}

- (NSString*)jobName {
	return kJobGetClusterOnlineMember;
}
...
- (BOOL)handleQQEvent:(QQNotification*)event {
	...
	switch([event eventId]) {
		...
		case kQQEventClusterGetOnlineMemberFailed:
